...
from src.tools.plotting_utils import plot_CI, create_monochromatic_palette, adjust_brightness_of_colors, plot_PCA
...
def main():
    ...
    # plot histogram of diameters at 0.2, 0.4, and 1.2 psi for age groups and set groups
