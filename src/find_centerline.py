...
FILEFOLDER = 'C:\\Users\\gt8mar\\Desktop\\data\\221010'
FILENAME = "vid40000segmented.png"
BRANCH_THRESH = 40
...
def main(SET='set_01', sample = 'sample_000'):
    ...
    np.savetxt('vid4_test_skeleton_coords_7.csv', sorted_skeleton_example, delimiter=',')
