"""
Filename: delete_centerlines.py
------------------------------------------------------
    ...
    for participant in os.listdir(source_folder):
        ...
        for location in os.listdir(os.path.join(source_folder, participant, date)):
            ...
            for file in file_list:
                os.remove(os.path.join(source_folder, participant, date, location, 'centerlines', file))
            for folder in folder_list:
                shutil.rmtree(os.path.join(source_folder, participant, date, location, 'centerlines', folder))            
    return 0
