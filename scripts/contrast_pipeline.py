"""
Filename: contrast_pipeline.py
------------------------------------------------------
This program runs a sequence of python programs to contrast capillary videos from moco files. 
The code checks the medians of the contrast to verify if the file needs to be sliced. 
    ...
    for location in locations:
        ...
        if location == 'locScan' or location == 'locTemp' or location == 'locEx':
            ...
            for video in video_folders:
                video_path =  os.path.join('/hpc/projects/capillary-flow/data', participant, date, location, "vids", video)
